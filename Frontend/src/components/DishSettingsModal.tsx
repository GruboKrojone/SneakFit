...
export default function DishSettingsModal({
    ...
    try {
      ...
      if (dishData) {
        ...
        try {
          ...
          const priorityIds = [
            dishData.mainImageId,
            dishData.secondaryImageId,
            dishData.thirdImageId,
          ];
  ...
  const handleAddEmptyStep = () => {
    const newId = -Math.abs(
      globalThis.crypto.getRandomValues(new Int32Array(1))[0] || Date.now(),
    );
    setSteps((prev) => [
      ...prev,
      {
  ...
  const handleSaveAllSteps = async () => {
    ...
    if (emptyStep) {
      const errorIds = new Set(
        steps.filter((s) => !s.description.trim()).map((s) => s.id),
      );
    ...
    try {
      ...
      for (const step of steps) {
        const stepName =
          step.name ||
          `${t("create_dish_modal_step")} ${steps.indexOf(step) + 1}`;
  ...
  const handleSaveCategories = async () => {
    ...
    try {
      const promises = [
        ...
        ...toRemove.map((id) =>
          CategoriesService.unassignFromDish(id, dish.id),
        ),
      ];
  ...
  const renderPhotos = () => (
    <div className="image-step-container">
      <p className="step-hint">{t("create_dish_modal_main_image_hint")}</p>
          ...
          return (
            ...
            >
              ...
              >
                ...
                {index === 0 && (
                  <span className="main-badge">{t("dish_main_badge")}</span>
                )}
              </div>
              <button
                type="button"
    ...
    <div className="form-container">
      ...
      <div className="form-group">
        <p className="visibility-text">
          {t("dish_settings_modal_current_privacy")}{" "}
          <strong>
            {dish?.isPublic
  ...
  const renderCategories = () => (
    <div className="form-container form-container--flex">
      <p className="step-hint">{t("create_dish_modal_categories_hint")}</p>
      ...
      >
        <button className="save-button" onClick={handleSaveCategories}>
  ...
  const renderMenu = () => (
    <div className="settings-menu">
      ...
      <button
        className="menu-button delete-button menu-button--delete"
    ...
    <div className="form-container">
      <div className="form-group">
        ...
        <input
          value={dish?.name || ""}
          onChange={(e) =>
            setDish(dish ? { ...dish, name: e.target.value } : null)
          }
    ...
    <div className="form-container">
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) =>
            setMacros({ ...macros, calories: Number(e.target.value) })
          }
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) =>
            setMacros({ ...macros, protein: Number(e.target.value) })
          }
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          value={macros.fat}
          onChange={(e) =>
            setMacros({ ...macros, fat: Number(e.target.value) })
          }
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          value={macros.carbs}
          onChange={(e) =>
            setMacros({ ...macros, carbs: Number(e.target.value) })
          }
        />
      </div>
    ...
    <div className="form-container">
      ...
      <div className="add-ingredient-form">
        ...
        >
          ...
          {addingIngredient
            ? t("submitting")
            : t("create_dish_modal_add_ingredient")}
        </button>
      </div>
    </div>
  );
  ...
  const renderSteps = () => (
    <div className="form-container">
                ...
                <div className="step-content-overflow">
                  <div className="step-form-group">
                    ...
                    <div className="step-textarea-wrapper">
                      ...
                      <div
                        className={`step-char-count ${step.description.length >= 500 ? "limit" : ""}`}
                      >
      ...
      <button type="button" className="add-btn" onClick={handleAddEmptyStep}>
